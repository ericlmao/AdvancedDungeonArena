...
import su.nightexpress.dungeons.nightcore.util.geodata.DimensionType;
...
public class DungeonSetup extends AbstractManager<DungeonPlugin> {
    ...
    public boolean createDungeon(@NotNull Player player, @NotNull String name) {
        ...
        dungeonConfig.setPrefix(TagWrappers.GRAY.wrap("[" + TagWrappers.WHITE.wrap(Placeholders.DUNGEON_NAME) + "]") + " ");
