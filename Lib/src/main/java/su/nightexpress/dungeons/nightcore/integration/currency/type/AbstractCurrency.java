package su.nightexpress.dungeons.nightcore.integration.currency.type;

import org.bukkit.entity.Player;
import org.jspecify.annotations.NonNull;
import su.nightexpress.dungeons.nightcore.bridge.currency.Currency;
import su.nightexpress.dungeons.nightcore.integration.currency.impl.DummyCurrency;
...
public abstract class AbstractCurrency implements Currency {
    ...
    public String format(double amount) {
        ...
        // Upstream gated this on CoreConfig.ECONOMY_PLACEHOLDERS_API_FORMAT (default: true).
