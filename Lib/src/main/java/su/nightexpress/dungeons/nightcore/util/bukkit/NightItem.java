...
public class NightItem implements Writeable {
    ...
    public static NightItem read(@NonNull FileConfig config, @NonNull String path) {
        ...
        if (material == null) {
            Bukkit.getLogger().warning("Invalid material '" + materialName + "'. Found in '" + config.getFile()
    ...
    public ItemStack getItemStack() {
        ItemStack stack = this.backend.withType(this.material);
    ...
    public @NonNull NightItem setPlayerProfile(@Nullable PlayerProfile profile) {
        this.meta.setPlayerProfile(profile);
        return this;
    }
